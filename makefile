...
LIBS   = -Liksemel -liksemel -lm -lc -labox -lvstring
# -ldebug
...
$(OBJDIR)oauthgroup.c.o: oauthgroup.c globaldefines.h oauthgroup.h gui.h locale.h \
 translations.h class.h iksemel/iksemel.h
	@$(COMPILE_FILE)
	@$(COMPILE) -c -o $(OBJDIR)oauthgroup.c.o oauthgroup.c

OBJS = $(OBJDIR)lib.c.o $(OBJDIR)class.c.o $(OBJDIR)gui.c.o $(OBJDIR)locale.c.o $(OBJDIR)ikshooks.c.o $(OBJDIR)events.c.o\
 $(OBJDIR)support.c.o $(OBJDIR)oauthgroup.c.o 
...
install: all
	@cp >NIL: $(PROJECT) B:src/bin/modules/
	@-copy >NIL: $(OUTDIR)Catalogs/ B:src/bin/Catalogs/ ALL
	@flushlib $(OUTFILE)
	@$(TARGET_DONE)
